                ...
                <a class="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-none focus:opacity-80"
                    ...
                    <svg class="w-28 h-auto" width="116" height="32" viewBox="0 0 116 32" fill="none"
                        ...
                        <path
                            ...
                            class="fill-blue-600 dark:fill-white" fill="currentColor"></path>
                        <path
            ...
            <div
                ...
                <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open="">
                    <ul class="flex flex-col space-y-1">
                        ...
                        <li v-for="sideBarItem in sideBarItems" class="hs-accordion text-gray-800 dark:text-neutral-200"
                            ...
                            <button type="button"
                                ...
                                <Icon class="  shrink-0 size-4" :class="sideBarItem.coustomClass"
                                    :name="sideBarItem.icon"  ></Icon>
                                <span class="mt-1 font-semibold">{{ sideBarItem.label }}</span>
                                <div class="ms-auto" v-if="sideBarItem.children && sideBarItem.children.length > 0">
                                    <Icon class="  hs-accordion-active:block  hidden size-4"
                            ...
                            <!-- child -->
                            <div v-if="sideBarItem.children && sideBarItem.children.length > 0"  
                                id="account-accordion-child"
                                class="hs-accordion-content opacity-80 w-full overflow-hidden transition-[height] duration-300 hidden"
                                role="region" aria-labelledby="account-accordion">
                                <ul class="ps-6 pt-1  space-y-1">

                                    <li v-for=" child in sideBarItem.children">
                                        <a class="flex items-center gap-x-2.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none  dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:text-neutral-200"
                                            href="#">
                                            <Icon :class="child.coustomClass" class="  shrink-0 size-4"
                                                :name="child.icon"  ></Icon>
                                            <span class="mt-1">{{ child.label }}</span>
                                        </a>
                                    </li>
