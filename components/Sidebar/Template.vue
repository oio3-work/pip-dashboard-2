<template>
  ...
  <div
    ...
    class="hs-overlay hs-overlay-open:translate-x-0 translate-x-full transition-all duration-300 transform w-[260px] h-full hidden fixed inset-y-0 start-0 z-[60] bg-white border-e border-gray-200 lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 dark:bg-neutral-800 dark:border-neutral-700"
    role="dialog"
    tabindex="-1"
    aria-label="Sidebar"
  >
    <div class="relative flex flex-col h-full max-h-full">
      ...
      <!-- Content -->
      <div class="h-full overflow-y-auto [&amp;::-webkit-scrollbar]:w-0">
        <nav
        ...
        >
          <ul class="flex flex-col space-y-1">
            <li
              ...
              class="hs-accordion text-gray-800 dark:text-neutral-200"
            ...
            >
              ...
              <!-- child -->
              <div
                v-if="sideBarItem.children && sideBarItem.children.length > 0"
